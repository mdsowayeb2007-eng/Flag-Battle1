...
export const ArenaCanvas: React.FC<ArenaCanvasProps> = ({
  ...
  return (
    <div className="relative w-full h-[calc(100vh-4rem)] bg-slate-950 flex flex-col justify-between overflow-hidden select-none">
      
      {/* TOP BOX: QUALIFIED FOR FINAL (MATCHING SCREENSHOT) */}
      <div className="w-full max-w-3xl mx-auto px-3 pt-2 pb-1 z-20 shrink-0">
